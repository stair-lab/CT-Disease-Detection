...
# if a models includes LSTM, such as in image captioning,
...
@main.command()
@click.option("-m", "--models-pth-path", type=str, required=True)
...
def test(model_pth_path, image_dir, num_classes, output_dir, start_class, batch_size, cuda):
    ...
    ## classes for models Ayis trained with fastai
    ...
    # Model
    ## Fast-AI ResNet34
    # models = fastai_resnet.resnet34(num_classes=num_classes)
    ## PyTorch ResNet34
    # models = resnet34.ResNet34(num_classes=num_classes)
    ## Coord Conv Model
